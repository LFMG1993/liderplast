            ...
            <div className="container marketing">
                ...
                <div className="row featurette">
                    <div className="col-md-7">
                        <h2 className="featurette-heading">Distribuidores de Plásticos Desechables
                        </h2>
                    ...
                    <div className="col-md-5">
                        <img className="img-fluid" src={ImagesHome.fachada} width={"500"} height={"400"} alt="foto" aria-label={"Imagen fachada"} loading={"lazy"}/>
                    </div>
                </div>
                ...
                <div className="row featurette">
                    <div className="col-md-7 order-md-2">
                        <h2 className="featurette-heading">Plásticos Desechables o de un solo uso.
                        </h2>
                    ...
                    <div className="col-md-5 order-md-1">
                        <img className="img-fluid" src={ImagesCategory.contenedorP} width={500} height={400} alt="foto"
                             aria-label={"Proveedor de productos"}/>
                    </div>
                </div>
