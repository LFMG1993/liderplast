        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            <div>
                ...
                <input type="text" name="nombre" id="nombre" value={formData.nombre} onChange={handleChange} required
                       className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2.5 text-gray-900"/>
            </div>
            <div>
            ...
            <div>
                <label htmlFor="password"
                       className="block text-sm font-medium text-gray-700">{isEditMode ? 'Nueva Contraseña (opcional)' : 'Contraseña'}</label>
