...
async function contactHandler(req, env) {
  let payload;
  try {
    payload = await req.json();
  } catch (e) {
    console.error("JSON inv\xE1lido:", e);
    return new Response("JSON inv\xE1lido", { status: 400 });
  }
...
// .wrangler/tmp/bundle-FZ6bWU/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-FZ6bWU/middleware-loader.entry.ts
